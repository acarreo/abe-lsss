...
//   OpenABE_ERROR generateParams();
//   OpenABE_ERROR generateDecryptionKey(const std::string &keyID,
//                                       const std::string &pkID,
//                                       const std::string &skID);

//   OpenABE_ERROR encryptKEM(const std::string &pkID, OpenABEByteString &senderID,
...
public:
  ...
  OpenABE_ERROR encrypt(const std::string &pkID, const std::string &senderpkID,
